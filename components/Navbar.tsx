            ...
            <div className="container mx-auto px-4 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-[500px] bg-white rounded-xl shadow-xl border border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0 p-6 grid grid-cols-2 gap-6 z-50">
                            {/* Arrow */}
                ...
                <div className="hidden md:flex items-center gap-4">
                    <a href="tel:4077207476" className={clsx("font-bold flex items-center gap-2 transition-colors hidden xl:flex", useDarkText ? "text-[#584D94]" : "text-white")}>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="pt-4 border-t border-slate-100 flex flex-col gap-3">
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <a href="sms:4077207476" className="bg-[#584D94]/10 text-[#584D94] font-bold py-3 rounded-xl flex items-center justify-center gap-2 border border-[#584D94]/20">
                                <span>💬</span> Text Us
                            </a>
                        </div>
                        <button
