    ...
    <main className="min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      <header className="relative bg-gradient-to-br from-[#584D94] via-[#7B6FCC] to-[#453A75] text-white pt-32 pb-24 px-4 text-center overflow-hidden">
        ...
        <div className="text-blue-200 text-sm opacity-90">
          ...
          <a href="sms:4077207476?body=Attached%20photos%20for%20quote%20for%20my%20furniture%20assembly..." className="hover:text-white underline underline-offset-2">💬 Send a photo for instant estimate</a>
        </div>
      </header>
      ...
      <section className="py-20 px-4 container mx-auto max-w-5xl text-center">
        ...
        <div className="bg-gradient-to-br from-[#584D94] to-[#453A75] text-white p-8 md:p-10 rounded-2xl max-w-3xl mx-auto shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="sms:4077207476?body=Attached%20photos%20for%20quote%20for%20my%20furniture%20assembly..." className="btn-gradient-primary btn-gradient-shimmer flex items-center gap-2 justify-center">
