...
export default function FurnitureAssemblyPage() {
  ...
  const serviceSchema = {
    ...
    "description": "Professional furniture assembly in Orlando. Fast, correct assembly from any retailer including IKEA, Amazon, and Wayfair.",
    "provider": {
      "@id": "https://fix.luxht.com/#localbusiness"
    },
    "areaServed": {
    ...
    <main className="min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      <header className="relative bg-gradient-to-br from-[#584D94] via-[#7B6FCC] to-[#453A75] text-white pt-32 pb-24 px-4 text-center overflow-hidden">
        <div className="relative z-10 container mx-auto max-w-4xl">
          ...
          <div className="flex items-center justify-center gap-2 text-sm md:text-base font-semibold text-[#64CEBB] mb-8 bg-white/10 backdrop-blur-md inline-flex py-2 px-6 rounded-full border border-white/20">
            <CheckCircle size={16} /> Fully Insured • 600+ Furniture Pieces Assembled in Orlando
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
            ...
            <a href="mailto:info@luxht.com?subject=Furniture%20Assembly%20Quote%20Request" className="btn-gradient-glass border-white/20 hover:bg-white/10">
        ...
        <div className="text-blue-200 text-sm opacity-90">
          <p className="font-bold">Furniture assembly starts at $75</p>
          <a href="sms:9543003043?body=Hi%2C%20I%20need%20a%20quick%20quote%20for%20my%20furniture%20assembly..." className="hover:text-white underline underline-offset-2">💬 Text for Instant Quote</a>
        </div>
      </header>
      ...
      <section className="py-20 px-4 container mx-auto max-w-5xl text-center">
        ...
        <div className="bg-gradient-to-br from-[#584D94] to-[#453A75] text-white p-8 md:p-10 rounded-2xl max-w-3xl mx-auto shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="sms:9543003043?body=Hi%2C%20I%20need%20a%20quick%20quote%20for%20my%20furniture%20assembly..." className="btn-gradient-primary btn-gradient-shimmer flex items-center gap-2 justify-center">
      ...
      <section className="py-24 bg-gradient-to-br from-[#584D94] via-[#7B6FCC] to-[#453A75] text-white text-center px-4">
        <div className="container mx-auto max-w-2xl">
          ...
          <p className="text-sm opacity-75">Fully Insured • Same-Week Service • All Retailers</p>
        </div>
      </section>
