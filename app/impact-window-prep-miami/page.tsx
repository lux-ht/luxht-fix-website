...
export const metadata: Metadata = {
  ...
  description: 'Professional impact window installation prep in South Florida. Serving Miami, Fort Lauderdale, Hollywood, Pembroke Pines & more. Fully Insured. Call today!',
...
export default function ImpactWindowPrepMiamiPage() {
  return (
    <ServicePageTemplate
      ...
      serviceDetails={["Professional impact window installation prep service","Expert craftsmanship and quality materials","Clean execution with area protection","Same-week scheduling available","Serving all of South Florida","Fully insured professionals"]}
      ...
      whyChooseUs={["Impact Window Installation Prep specialists serving South Florida","Professional-grade materials and tools","Clean, respectful execution in your home","Transparent pricing with no hidden fees","Same-week service across Miami-Dade & Broward","Fully insured and background-checked"]}
