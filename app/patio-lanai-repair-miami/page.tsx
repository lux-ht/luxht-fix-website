...
export const metadata: Metadata = {
  ...
  description: 'Professional patio & lanai repair in South Florida. Serving Miami, Fort Lauderdale, Hollywood, Pembroke Pines & more. Fully Insured. Call today!',
...
export default function PatioLanaiRepairMiamiPage() {
  return (
    <ServicePageTemplate
      ...
      serviceDetails={["Professional patio & lanai repair service","Expert craftsmanship and quality materials","Clean execution with area protection","Same-week scheduling available","Serving all of South Florida","Fully insured professionals"]}
      ...
      whyChooseUs={["Patio & Lanai Repair specialists serving South Florida","Professional-grade materials and tools","Clean, respectful execution in your home","Transparent pricing with no hidden fees","Same-week service across Miami-Dade & Broward","Fully insured and background-checked"]}
