...
export default function SmartHomeMiamiPage() {
  return (
    <ServicePageTemplate serviceName="Smart Home Installation" slug="smart-home-installation-miami" location="miami"
      ...
      whyChooseUs={['Smart home specialists in South Florida','All major brands: Ring, Nest, Schlage, August, Yale','Full app setup and training included','Wi-Fi optimization for reliable performance','Same-week service across Miami-Dade & Broward','Fully insured and background-checked']}
      faqs={[
