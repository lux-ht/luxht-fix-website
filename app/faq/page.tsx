            ...
            <section className="py-20 bg-white px-4 border-t border-slate-100">
                <div className="container mx-auto max-w-3xl text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="tel:4072880832" className="bg-[#584D94] text-white font-bold py-4 px-8 rounded-full hover:shadow-lg transition-all flex items-center justify-center gap-2">
                            <Phone size={20} /> Call (407) 288-0832
                        </a>
