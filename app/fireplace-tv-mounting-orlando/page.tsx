    ...
    return (
        <ServicePageTemplate
            ...
            faqs={[
                ...
                { q: "How much does fireplace TV mounting cost?", a: "Fireplace TV mounting typically ranges from $200 to $450 depending on wall material, mount type, and cable concealment method. Text us a photo of your fireplace at (954) 300-3043 for a personalized quote." }
            ]}
            relatedServices={[
