...
export default function FaucetFixturesMiamiPage() {
  return (
    <ServicePageTemplate serviceName="Faucet & Fixture Installation" slug="faucet-fixtures-miami" location="miami"
      ...
      whyChooseUs={['Fixture installation specialists in South Florida','All major brands installed','Leak-free installation guaranteed','Hard water considerations for South Florida','Same-week service across Miami-Dade & Broward','Licensed, insured, and background-checked']}
      faqs={[
