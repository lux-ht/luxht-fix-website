...
export const metadata: Metadata = {
  ...
  description: 'Professional water damage drywall repair in South Florida. Serving Miami, Fort Lauderdale, Hollywood, Pembroke Pines & more. Fully Insured. Call today!',
...
export default function WaterDamageDrywallRepairMiamiPage() {
  return (
    <ServicePageTemplate
      ...
      whyChooseUs={["Water damage repair experts in South Florida","Professional moisture testing equipment","Mold prevention protocols included","Hurricane and storm damage experience","Same-week emergency service available","Fully insured and background-checked"]}
