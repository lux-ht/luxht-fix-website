...
export const metadata: Metadata = {
  ...
  description: 'Professional smart doorbell installation in South Florida. Serving Miami, Fort Lauderdale, Hollywood, Pembroke Pines & more. Fully Insured. Call today!',
...
export default function SmartDoorbellInstallationMiamiPage() {
  return (
    <ServicePageTemplate
      ...
      serviceDetails={["Professional smart doorbell installation service","Expert craftsmanship and quality materials","Clean execution with area protection","Same-week scheduling available","Serving all of South Florida","Fully insured professionals"]}
      ...
      whyChooseUs={["Smart Doorbell Installation specialists serving South Florida","Professional-grade materials and tools","Clean, respectful execution in your home","Transparent pricing with no hidden fees","Same-week service across Miami-Dade & Broward","Fully insured and background-checked"]}
