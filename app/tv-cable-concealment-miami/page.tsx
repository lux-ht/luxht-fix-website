...
export const metadata: Metadata = {
  ...
  description: 'Professional tv cable concealment in South Florida. Serving Miami, Fort Lauderdale, Hollywood, Pembroke Pines & more. Fully Insured. Call today!',
...
export default function TvCableConcealmentMiamiPage() {
  return (
    <ServicePageTemplate
      ...
      whyChooseUs={["Cable concealment specialists in South Florida","In-wall and surface solutions for any wall type","Condo-friendly installations (no structural changes)","Clean, organized results every time","Same-week service across Miami-Dade & Broward","Fully insured and background-checked"]}
