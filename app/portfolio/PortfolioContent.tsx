...
const projects = [
    ...
    },
    {
        ...
        highlights: ["Shaker doors", "Soft-close hinges", "New hardware", "Fresh paint"]
    },
    {
    ...
    },
    {
        ...
        cost: "$425",
        duration: "3 hours",
        description: "85\" TV mounted above fireplace with concealed cables, soundbar mount, and outlet relocation.",
        highlights: ["Cable concealment", "Soundbar mount", "Equipment shelf", "Clean install"]
    },
    {
        ...
        cost: "$1,800",
        duration: "1 day",
        description: "Full smart home upgrade with video doorbell, smart locks, thermostat, and 4 security cameras.",
        highlights: ["Ring doorbell", "Smart locks", "Nest thermostat", "4 cameras"]
    },
    {
        title: "Front Door & Lock Upgrade",
        location: "Maitland, FL",
        service: "Door, Lock & Trim",
