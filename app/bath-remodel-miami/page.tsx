...
export default function BathRemodelMiamiPage() {
  return (
    <ServicePageTemplate serviceName="Bathroom Remodel" slug="bath-remodel-miami" location="miami"
      ...
      whyChooseUs={['Complete bathroom renovation specialists','Custom designs for South Florida homes and condos','Quality materials suited for tropical humidity','Transparent pricing with detailed estimates','On-time project completion (2-3 weeks typical)','Fully insured and background-checked']}
      faqs={[
