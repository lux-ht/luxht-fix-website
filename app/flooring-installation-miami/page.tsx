...
export default function FlooringMiamiPage() {
  return (
    <ServicePageTemplate serviceName="Flooring Installation" slug="flooring-installation-miami" location="miami"
      ...
      whyChooseUs={['Flooring specialists with humidity-resistant expertise','All materials: hardwood, LVP, laminate, tile','Proper subfloor preparation for South Florida conditions','Warranty-compliant installation methods','Clean execution with minimal disruption','Fully insured and background-checked']}
      faqs={[
