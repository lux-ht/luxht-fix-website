...
export const metadata: Metadata = {
  ...
  description: 'Professional smart lock installation in South Florida. Serving Miami, Fort Lauderdale, Hollywood, Pembroke Pines & more. Licensed & Insured. Call today!',
...
export default function SmartLockInstallationMiamiPage() {
  return (
    <ServicePageTemplate
      ...
      serviceDetails={["Professional smart lock installation service","Expert craftsmanship and quality materials","Clean execution with area protection","Same-week scheduling available","Serving all of South Florida","Licensed and insured professionals"]}
      ...
      whyChooseUs={["Smart Lock Installation specialists serving South Florida","Professional-grade materials and tools","Clean, respectful execution in your home","Transparent pricing with no hidden fees","Same-week service across Miami-Dade & Broward","Licensed, insured, and background-checked"]}
