...
export const metadata: Metadata = {
  ...
  description: 'Professional drywall crack repair in South Florida. Serving Miami, Fort Lauderdale, Hollywood, Pembroke Pines & more. Licensed & Insured. Call today!',
...
export default function DrywallCrackRepairMiamiPage() {
  return (
    <ServicePageTemplate
      ...
      whyChooseUs={["Crack repair specialists serving South Florida","Root cause analysis before repair","Fiberglass mesh reinforcement for permanence","Seamless texture matching guaranteed","Same-week service across Miami-Dade & Broward","Licensed, insured, and background-checked"]}
