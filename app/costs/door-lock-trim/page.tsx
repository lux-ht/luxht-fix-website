            ...
            <header className="relative bg-gradient-to-br from-[#584D94] to-[#7B6FCC] pt-32 pb-16 overflow-hidden">
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-white/80 mb-8 max-w-2xl">Get pricing for door installation, lock replacement, and trim work in South Florida & Central Florida.</p>
                ...
                <div className="container mx-auto max-w-4xl">
                    ...
                    <section className="mb-16 bg-gradient-to-br from-[#584D94] to-[#7B6FCC] rounded-2xl p-8 text-white">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-8">
                            <div className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-[#64CEBB] flex-shrink-0" /><span className="font-semibold">Precise Fitting</span></div>
                            <div className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-[#64CEBB] flex-shrink-0" /><span className="font-semibold">Clean Finish</span></div>
                        </div>
