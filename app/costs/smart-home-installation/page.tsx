            ...
            <header className="relative bg-gradient-to-br from-[#584D94] to-[#7B6FCC] pt-32 pb-16 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-white/80 mb-8 max-w-2xl leading-relaxed">Get pricing for smart thermostats, doorbells, locks, and full home automation in South Florida & Central Florida.</p>
                ...
                <div className="container mx-auto max-w-4xl">
                    ...
                    <section className="mb-16 bg-gradient-to-br from-[#584D94] to-[#7B6FCC] rounded-2xl p-8 text-white">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <a href="tel:9543003043" className="border-2 border-white text-white font-bold py-3 px-6 rounded-full hover:bg-white/10 transition-all inline-flex items-center justify-center gap-2"><Phone size={20} /> (954) 300-3043</a>
                        </div>
                    </section>
